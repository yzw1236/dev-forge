    ...
    <div className="p-4 md:p-8">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mt-12 text-center">
          <h2 className="text-2xl font-bold mb-8 text-slate-800 dark:text-slate-200">Crontab Tool Features</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold mb-2 text-slate-800 dark:text-slate-200">One-click Templates</h3>
              <p className="text-sm text-slate-600 dark:text-slate-400">Insert common crontab expressions with one click</p>
            </div>
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold mb-2 text-slate-800 dark:text-slate-200">Expression Validation</h3>
              <p className="text-sm text-slate-600 dark:text-slate-400">Quickly check if the expression format is correct</p>
            </div>
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold mb-2 text-slate-800 dark:text-slate-200">Expression Explanation</h3>
              <p className="text-sm text-slate-600 dark:text-slate-400">See the meaning of minute, hour, day, month, week at a glance</p>
            </div>
          </div>
        </div>
      </div>
